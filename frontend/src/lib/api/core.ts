...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  social_channel_configuration_changed: "Buffer channels changed since this was drafted — use Re-draft.",
  social_proposal_has_no_source: "Only proposals drafted from a published source can be re-drafted.",
  ...
  social_utm_without_destination: "UTM parameters need a destination URL.",
  ...
  operator_api_token_exists: "That API token already exists.",
  operator_api_token_not_found: "That API token is no longer available.",
  operator_api_token_revoked: "That API token has been revoked.",
  operator_capability_denied: "This credential cannot perform that action.",
